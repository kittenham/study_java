...
public class AnonymousApp {
	public static void main(String[] args) {
		//interface를 사용하여 참조변수는 생성가능하지만, 객체 생성은 불가능하다.
		...
		//인터페이스를 상속받은 이름이 없는 자식 클래스를 선언하고 인터페이스의 메소드를 오버라이드 선언하여 객체 생성이 가능하다.
		//오버라이드 선언하여 객체 생성 가능 - 익명의 내부클래스(지역클래스)
		//익명의 내부클래스(Anonymous InnerClass) : 인터페이스 또는 추상클래스를 상속받은 이름이 없는 자식클래스 - 익명의 내부클래스로 하나의 객체를 생성하여 사용
		//=> 익명의 내부클래스는 상속받은 인터페이스 또는 추상클래스의 모든 추상메소드를 오버라이드 선언해야함.
