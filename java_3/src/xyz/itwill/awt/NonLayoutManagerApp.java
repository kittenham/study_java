...
//컨테이너는 컴퍼넌트 자동 배치하기 위한 배치관리자가 초기화 설정 - 기본 배치관리자
...
public class NonLayoutManagerApp extends Frame {
	...
	public NonLayoutManagerApp(String title) {
		...
		setLayout(null);	//null을 넣으면, 프레임은 배치관리자를 사용하지 않도록 설정 할 수 있다.
		
		Button button1 = new Button("BUTTON-1");
		Button button2 = new Button("BUTTON-2");
		
		//배치관리자를 사용하지 않을 경우 반드시 컴퍼넌트의 크기와 출력위치를 변경한 후 배치
		button1.setBounds(80, 100, 150, 80);	//앞에 숫자 두개는 위치. 뒤에 두개는 버튼 크기(가로*세로)
